...
class _ExportScreenState extends State<ExportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(TimeCopLocalizations.of(context).export),
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () async {
              ...
              await FlutterShare.shareFile(title: "timecop.db", filePath: dbPath);
            },
          )
        ],
      ),
        ...
        children: <Widget>[
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  TimeCopLocalizations.of(context).filter,
                  style: TextStyle(
          ...
          Slidable(
            ...
            child: ListTile(
              ...
              title: Text(TimeCopLocalizations.of(context).from),
          ...
          Slidable(
            ...
            child: ListTile(
              leading: Icon(FontAwesomeIcons.calendar),
              title: Text(TimeCopLocalizations.of(context).to),
              ...
              return Expanded(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ListTile(
                      title: Text(
                        TimeCopLocalizations.of(context).includeProjects,
                        style: TextStyle(
                          color: Theme.of(context).accentColor,
                    ...
                    Expanded(
                      ...
                      child: ListView(
                        children: <Project>[null].followedBy(state.projects).map((project) => ListTile(
                          ...
                          title: Text(project?.name ?? TimeCopLocalizations.of(context).noProject),
                          trailing: Checkbox(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          List<List<String>> data = <List<String>>[
            <String>[TimeCopLocalizations.of(context).project, TimeCopLocalizations.of(context).description, TimeCopLocalizations.of(context).timeH],
          ]
          .followedBy(
            timers.state.timers
          ...
          await FlutterShare.shareFile(title: "timecop.csv", filePath: localPath);
        }
        ),
    );
  }
