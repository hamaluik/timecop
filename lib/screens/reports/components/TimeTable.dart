...
class TimeTable extends StatelessWidget {
  ...
  const TimeTable({Key key, @required this.startDate, @required this.endDate, @required this.selectedProjects}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final double totalHours = projectHours.values.fold(0.0, (double sum, double v) => sum + v);
