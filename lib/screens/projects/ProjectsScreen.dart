...
class ProjectsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(TimeCopLocalizations.of(context).projects),
      ),
                      ...
                      builder: (BuildContext context) => AlertDialog(
                        ...
                        content: RichText(
                          ...
                          text: TextSpan(
                            ...
                            children: <TextSpan>[
                              TextSpan(text: TimeCopLocalizations.of(context).areYouSureYouWantToDeletePrefix),
                              TextSpan(text: "⬤ ", style: TextStyle(color: project.colour)),
                              TextSpan(text: project.name, style: TextStyle(fontStyle: FontStyle.italic)),
                              TextSpan(text: TimeCopLocalizations.of(context).areYouSureYouWantToDeletePostfix),
                            ]
                          )
                        ),
                        actions: <Widget>[
