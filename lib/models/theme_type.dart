...
ThemeType themeFromString(String type) {
  ...
  switch(type) {
    case "auto": return ThemeType.auto;
    case "light": return ThemeType.light;
    case "dark": return ThemeType.dark;
    case "black": return ThemeType.black;
    default: return ThemeType.auto;
  }
}
