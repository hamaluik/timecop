...
class TimerEntry extends Equatable {
  ...
  TimerEntry({@required this.id, @required this.description, @required this.projectID, @required this.workTypeID, @required this.startTime, @required this.endTime})
      : assert(id != null),
        assert(startTime != null);

  @override List<Object> get props => [id, description, projectID, workTypeID, startTime, endTime];
