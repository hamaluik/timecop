...
class MockDataProvider extends DataProvider {
  ...
  Future<List<WorkType>> listWorkTypes() async {
    return <WorkType>[
      WorkType(id: 1, name: "Requirements", colour: Colors.cyan[600]),
      WorkType(id: 2, name: "Documentation", colour: Colors.pink[600]),
      WorkType(id: 3, name: "Development", colour: Colors.blue[600]),
      WorkType(id: 4, name: "Testing", colour: Colors.green[600]),
      WorkType(id: 5, name: "Deployment", colour: Colors.yellow[600]),
    ];
  }
  ...
  Future<WorkType> createWorkType({@required String name, Color colour}) async {
    return WorkType(id: -1, name: name, colour: colour);
  }
