...
class FluentL10NProvider extends L10NProvider {
  ...
  String get areYouSureYouWantToDelete =>
      _bundle.format("areYouSureYouWantToDelete", errors: _errors) ?? "areYouSureYouWantToDelete";
  @override
  ...
  @override
  String get stopTimer => _bundle.format("stopTimer", errors: _errors) ?? "stopTimer";
  @override
  String get resumeTimer => _bundle.format("resumeTimer", errors: _errors) ?? "resumeTimer";
  @override
  ...
  @override
  String get exportImport => _bundle.format("exportImport", errors: _errors) ?? "exportImport";
  @override
  String get exportCSV => _bundle.format("exportCSV", errors: _errors) ?? "exportCSV";
  @override
  String get exportDatabase => _bundle.format("exportDatabase", errors: _errors) ?? "exportDatabase";
  @override
  String get importDatabase => _bundle.format("importDatabase", errors: _errors) ?? "importDatabase";
  @override
  ...
  @override
  String get unarchive => _bundle.format("unarchive", errors: _errors) ?? "unarchive";
  @override
  String get startTimer => _bundle.format("startTimer", errors: _errors) ?? "startTimer";
  @override
  String get stopAllTimers => _bundle.format("stopAllTimers", errors: _errors) ?? "stopAllTimers";
  @override
  String get startNewTimer => _bundle.format("startNewTimer", errors: _errors) ?? "startNewTimer";
  @override
  String get timerMenu => _bundle.format("timerMenu", errors: _errors) ?? "timerMenu";
  @override
  String get closeMenu => _bundle.format("closeMenu", errors: _errors) ?? "closeMenu";
  @override
  String get search => _bundle.format("search", errors: _errors) ?? "search";
  @override
  String get setToCurrentTime => _bundle.format("setToCurrentTime", errors: _errors) ?? "setToCurrentTime";
  @override
  String timeCopDatabase(String date) =>
      _bundle.format("timeCopDatabase", args: <String, dynamic>{"date": date}, errors: _errors) ?? "timeCopDatabase";
  @override
  String timeCopEntries(String date) =>
      _bundle.format("timeCopEntries", args: <String, dynamic>{"date": date}, errors: _errors) ?? "timeCopEntries";
  @override
  ...
  String get combinedProjectDescription =>
      _bundle.format("combinedProjectDescription", errors: _errors) ?? "combinedProjectDescription";
  @override
  String get reports => _bundle.format("reports", errors: _errors) ?? "reports";
  @override
  String nHours(String hours) =>
      _bundle.format("nHours", args: <String, dynamic>{"hours": hours}, errors: _errors) ?? "nHours";
  @override
  ...
  @override
  String get compactView => _bundle.format("compactView", errors: _errors) ?? "compactView";
  @override
  ...
  String get autocompleteDescription =>
      _bundle.format("autocompleteDescription", errors: _errors) ?? "autocompleteDescription";
  @override
  String get defaultFilterStartDateToMonday =>
      _bundle.format("defaultFilterStartDateToMonday", errors: _errors) ?? "defaultFilterStartDateToMonday";
  @override
  String get hours => _bundle.format("hours", errors: _errors) ?? "hours";
  @override
  String get total => _bundle.format("total", errors: _errors) ?? "total";
  @override
  String get oneTimerAtATime => _bundle.format("oneTimerAtATime", errors: _errors) ?? "oneTimerAtATime";
  @override
  String get selectAll => _bundle.format("selectAll", errors: _errors) ?? "selectAll";
  @override
  String get selectNone => _bundle.format("selectNone", errors: _errors) ?? "selectNone";
  @override
  String get showBadgeCounts => _bundle.format("showBadgeCounts", errors: _errors) ?? "showBadgeCounts";
  @override
  String get defaultFilterDays => _bundle.format("defaultFilterDays", errors: _errors) ?? "defaultFilterDays";
  @override
  String get invalidDatabaseFile => _bundle.format("invalidDatabaseFile", errors: _errors) ?? "invalidDatabaseFile";
  @override
  String get databaseImported => _bundle.format("databaseImported", errors: _errors) ?? "databaseImported";
  @override
  String get storageAccessRequired =>
      _bundle.format("storageAccessRequired", errors: _errors) ?? "storageAccessRequired";
  @override
  String get runningTimersNotificationTitle =>
      _bundle.format("runningTimersNotificationTitle", errors: _errors) ?? "runningTimersNotificationTitle";
  @override
  String get runningTimersNotificationBody =>
      _bundle.format("runningTimersNotificationBody", errors: _errors) ?? "runningTimersNotificationBody";
  @override
  String get enableRunningTimersNotification =>
      _bundle.format("enableRunningTimersNotification", errors: _errors) ?? "enableRunningTimersNotification";
  @override
  String get notes => _bundle.format("notes", errors: _errors) ?? "notes";
  @override
  String get noItemsFound => _bundle.format("noItemsFound", errors: _errors) ?? "noItemsFound";
  @override
  String filterFrom(String dateFrom) =>
      _bundle.format("filterFrom", args: <String, dynamic>{"dateFrom": dateFrom}, errors: _errors) ?? "filterFrom";
  @override
  String filterUntil(String dateUntil) =>
      _bundle.format("filterUntil", args: <String, dynamic>{"dateUntil": dateUntil}, errors: _errors) ?? "filterUntil";
  @override
  String filterFromUntil(String dateFrom, String dateUntil) =>
      _bundle.format("filterFromUntil",
          args: <String, dynamic>{"dateFrom": dateFrom, "dateUntil": dateUntil}, errors: _errors) ??
      "filterFromUntil";
