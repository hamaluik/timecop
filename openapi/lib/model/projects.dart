...
class Projects {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Projects[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Projects[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Projects> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Projects>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Projects.listFromJson(
          entry.value,
          growable: growable,
        );
      }
