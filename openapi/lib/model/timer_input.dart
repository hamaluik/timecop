...
class TimerInput {
  /// Returns a new [TimerInput] instance.
  TimerInput({
    required this.timer,
  });
  ...
  /// Returns a new [TimerInput] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TimerInput? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return TimerInput(
        timer: TimerInputTimer.fromJson(json[r'timer'])!,
      );
    }
    return null;
  }
  ...
  static List<TimerInput> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TimerInput.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TimerInput> mapFromJson(dynamic json) {
    final map = <String, TimerInput>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TimerInput.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
